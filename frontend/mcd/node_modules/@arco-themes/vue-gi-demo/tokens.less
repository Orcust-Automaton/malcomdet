...
@link-color-text: rgb(var(--primary-6));
...
@input-color-bg: var(--color-bg-1);
@input-color-bg_hover: transparent;
@input-color-bg_focus: var(--color-bg-2);
@input-color-bg_disabled: var(--color-bg-2);
@input-color-addon-bg: var(--color-bg-1);
...
@picker-color-border_focus: rgb(var(--link-6));
...
@btn-secondary-color-bg_disabled: var(--color-bg-2);
@btn-secondary-color-bg_hover: transparent;
@btn-secondary-color-bg_active: var(--color-neutral-2);
@btn-secondary-color-border: var(--color-border-3);
@btn-secondary-color-border_disabled: var(--color-border-2);
@btn-secondary-color-border_hover: var(--color-border-4);
@btn-secondary-color-border_active: var(--color-border-3);
...
@overflow-prefix-cls: arco-overflow-list;
...
@scroll-prefix-cls: arco-scrollbar;
