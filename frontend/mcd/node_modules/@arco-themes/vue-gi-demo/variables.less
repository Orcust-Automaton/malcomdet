...
@color-border-2: rgb(235, 238, 245);
...
@color-bg-1: #ffffff;
@color-border-1: rgb(242, 246, 252);
...
@btn-secondary-color-border_hover: var(~'@{arco-cssvars-prefix}-color-border-4');
@btn-secondary-color-bg_active: @color-fill-2;
@btn-secondary-color-border_active: var(~'@{arco-cssvars-prefix}-color-border-3');
...
@input-color-bg: var(~'@{arco-cssvars-prefix}-color-bg-1');
...
@modal-default-padding-footer-vertical: 14px;
...
@picker-color-border_focus: @color-link-6;
...
@table-color-border: var(~'@{arco-cssvars-prefix}-color-border-2');
...
@tabs-line-size-header-border: 0.8px;
...
@btn-secondary-color-bg_disabled: var(~'@{arco-cssvars-prefix}-color-bg-2');
...
@input-color-bg_disabled: var(~'@{arco-cssvars-prefix}-color-bg-2');
...
@link-color-text: @color-primary-6;
@link-color-text_hover: @color-primary-5;
@link-color-text_active: @color-primary-7;
